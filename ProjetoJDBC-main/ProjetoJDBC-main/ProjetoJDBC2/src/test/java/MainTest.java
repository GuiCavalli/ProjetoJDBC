...
public class MainTest {
    ...
    public void testListarTodosClientes() {
        Main.inserirCliente("Jessica", "111.111.111-11");
        Main.inserirCliente("Cleber", "222.222.222-22");
        Main.inserirCliente("Otavio", "333.333.333-33");
    ...
    public void testExcluirTodosProdutos() {
        Main.inserirProduto("Mouse", 100.00);
        Main.inserirProduto("Teclado", 200.00);
    ...
    public void testExcluirTodosUsuarios() {
        Main.inserirUsuario("Usuario1", "132156", "Jessica", "2000-01-01");
        Main.inserirUsuario("Usuario2", "565469", "Cleber", "1999-02-02");
