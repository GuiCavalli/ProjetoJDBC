...
public class MainTest {
    ...
    // Método para limpar os dados após cada teste
    @After
    ...
    public void testListarTodosUsuarios() {
        ...
        // Testando se o número de usuários listados é igual ao número inserido
    ...
    public void testListarTodosProdutos() {
        ...
        // Testando se o número de produtos listados é igual ao número inserido
    ...
    public void testListarTodosClientes() {
        ...
        // Testando se o número de clientes listados é igual ao número inserido
